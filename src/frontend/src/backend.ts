...
export class Backend implements backendInterface {
    ...
    async getActiveOrders(): Promise<Array<bigint>> {
        if (this.processError) {
            try {
    ...
    async getCanisterPrincipal(): Promise<string> {
        if (this.processError) {
            try {
    ...
    async initCanisterPrincipal(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initCanisterPrincipal();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async withdrawCKUSDT(arg0: bigint, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.withdrawCKUSDT(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async withdrawICP(arg0: bigint, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
